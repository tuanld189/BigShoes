                        ...
                        <div class="page-header">
                            ...
                            <?php
                                ...
                                if(array_key_exists("btn_insert",$_REQUEST)){
                                    ...
                                    hang_hoa_insert($ten_hh,$hinh,$don_gia,$giam_gia,$mo_ta,$ma_loai,$size,$mauSac,$so_luong);
                                    unset($ten_hh,$hinh,$don_gia,$giam_gia,$mo_ta,$ma_loai,$size,$mauSac,$so_luong);
                                }
                            ?>
                            <!-- /. CONTENT  -->
                            ...
                            <input type="number" class="form-control" id="so_luong" name="so_luong" min="0" max="100"
