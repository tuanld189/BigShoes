			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method = "post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<label for="" style="color:white;">Tên đăng nhập</label>
						<input class="input100" type="text" name="ma_kh" >
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter Họ và tên">
						<label for="" style="color:white;">Họ và tên</label>
						<input class="input100" type="text" name="ho_ten">
						<span class="focus-input100" class='fas'></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter Địa chỉ">
						<label for="" style="color:white;">Địa chỉ</label>
